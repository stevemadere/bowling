...
To record a roll after adding a Player to a Game, PUT to the route "/games/GAME_ID/players/PLAYER_ID/game_frames" with params:
  * frame_number (1-10)
  * roll_number (1-2) for frames 1-9, (1-3) for frame 10
  * pins_toppled (0-10) for rolls 1 or 3 , (0-remaining_pins) for roll2

If you don't like to use HTTP PUT, you can also choose to GET or POST with the added param of "method: PUT"
